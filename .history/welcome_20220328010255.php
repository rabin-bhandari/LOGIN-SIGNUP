                              ...
                              <form id="edit-form" method="post" action="edit_user.php" class="needs-validation" novalidate>
                                ...
                                <div class="form-row">
                                  <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" id="newPass" name="newPass" oninput="validate_edit_pw2(this)" placeholder=" Enter Password" required />
                                  </div>
                                </div>
                                <div class="form-row">
                                  <div class="mb-3">
                                    <label for="newPass2" class="form-label">Confirm Password</label>
                                    <input type="password" class="form-control" id="newPass2" name="newPass2" oninput="validate_edit_pw2(this)" placeholder="Re-Enter Password" required />
