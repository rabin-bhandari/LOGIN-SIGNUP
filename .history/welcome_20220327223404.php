                                ...
                                <div class="row g-3 mb-3">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <select class="form-select" id="validationServer04" aria-describedby="validationServer04Feedback" required>
                                      ...
                                      <option selected value="<?php echo $admin; ?>"><strong><?php echo ($admin == 1) ? 'Admin' : 'User'; ?></strong></option>
                                      <option value="<?php echo ($admin == 1) ? '0' : '1'; ?>"><strong><?php echo ($admin == 1) ? 'User' : 'Admin'; ?></strong></option>
                                    </select>
