                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form id="edit-form" method="post" action="edit_user.php" class="needs-validation" novalidate>
                                ...
                                <div class="form-row">
                                  <div class="mb-3">
                                    <input type="password" class="form-control" name="passpass" id="passpass" name="passpass" placeholder="Enter Password" required />
                                  </div>
                                </div>
                                <div class="form-row">
                                  <div class="mb-3">
                                    <input type="password" class="form-control" name="passpass2" id="passpass2" name="passpass2" oninput="validate_edit_pw2(this)" placeholder="Re-Enter Password" required />
