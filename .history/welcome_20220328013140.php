                              ...
                              <form id="edit-form" method="post" action="edit_user.php" class="needs-validation" novalidate>
                                ...
                                <div class="form-row">
                                  <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" name="newPass" id="<?php echo ($admin == 1) ? 0 : 1; ?>" placeholder=" Enter Password" required />
                                  </div>
                                </div>
                                <div class="form-row">
                                  <div class="mb-3">
                                    <label for="newPass2" class="form-label">Confirm Password</label>
                                    <input type="password" class="form-control" name="newPass2" id="newPass2" oninput="validate_edit_pw2(this)" placeholder="Re-Enter Password" required />
                                ...
                                <!-- 
                                <div class="form-row">
                                  <input type="text" name="vlad3" id="vlad3" placeholder="jojo" oninput=test() required />
                                </div> -->
