                                ...
                                <div class="row g-3 mb-3">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <select class="form-select" id="validationServer04" aria-describedby="validationServer04Feedback" required>
                                      <option selected value="<?php echo $admin; ?>" style="font-weight: bold;"><?php echo ($admin == 1) ? 'Admin' : 'User'; ?></option>
                                      <option value="<?php echo ($admin == 1) ? '0' : '1'; ?>" style="font-weight: bold;"><?php echo ($admin == 0) ? 'Admin' : 'User'; ?></option>
                                    </select>
                                  </div>
