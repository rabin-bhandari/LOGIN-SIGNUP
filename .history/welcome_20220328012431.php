      ...
      <div class="admin-container">
        <div class="card text-center">
          <div class="card-header">
            Hello <?php echo $_SESSION['first_name']; ?>! <span class="wave">👋</span>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form id="edit-form" method="post" action="edit_user.php" class="needs-validation" novalidate>
                                ...
                                <div class="row g-3 mb-3">
                                  ...
                                  <div class="col-md-5 mb-3">
                                    ...
                                    <select class="form-select" name="role" id="role" aria-describedby="validationServer04Feedback" required>
                                      ...
                                      <option value="<?php echo ($admin == 1) ? 0 : 10; ?>"><?php echo ($admin == 0) ? 'Admin' : 'User'; ?></option>
                                    </select>
                                  </div>
                                  <div class="form-row">
                                    <input class="form-control" type="text" name="vlad3" id="vlad3" placeholder="jojo" oninput=test() required />
                                  </div>
                              ...
                              <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="vlad1" id="vlad1" placeholder=" Enter Password" required />
                              </div>
                          </div>
                          <div class="form-row">
                            <div class="mb-3">
                              <label for="newPass2" class="form-label">Confirm Password</label>
                              <input type="password" class="form-control" name="vlad2" id="vlad2" oninput="validate_edit_pw2(this)" placeholder="Re-Enter Password" required />
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Delete Account</button>
                              </div>
                            </div>
