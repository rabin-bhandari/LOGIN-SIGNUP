                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form id="edit-form" method="post" action="edit_user.php" class="needs-validation" novalidate>
                                ...
                                <div class="form-row">
                                  <div class="mb-3">
                                    <input type="password" class="form-control" name="newPass" id="newPass" name="newPass" placeholder="Enter Password" required />
                                  </div>
                                </div>
                                <div class="form-row">
                                  <div class="mb-3">
                                    <input type="password" class="form-control" name="newPass2" id="newPass2" name="newPass2" oninput="validate_edit_pw2(this)" placeholder="Re-Enter Password" required />
